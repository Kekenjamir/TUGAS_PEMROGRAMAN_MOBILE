...
-- Dumping structure for table crud.tbl_mapel
CREATE TABLE IF NOT EXISTS `tbl_mapel` (
  `id_mapel` int(10) NOT NULL AUTO_INCREMENT,
  `kd_mapel` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `nama_mapel` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
